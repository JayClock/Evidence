...
- contract runner 连接已迁移的临时 PostgreSQL 并启动唯一 Nest Server，黑盒验证 Workspace、Member、Inbox、Candidate 决定、Story Revision/Scenario、CodingRun lifecycle、Diagram、Relationship、错误与 media type；Server contract 不启动 Pi provider。
