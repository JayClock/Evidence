...
- contract runner 连接已迁移的临时 PostgreSQL，启动唯一 Nest Server 和 fake OpenAI-compatible Pi provider，黑盒验证 Workspace、Member、Inbox、Candidate 确认/拒绝、Story Revision v1、Diagram、Relationship、错误、media type 与 SSE。
