...
pub(super) fn workspace_diagram_href(workspace_id: &str) -> String {
    format!("/api/workspaces/{workspace_id}/diagram")
}

pub(super) fn workspace_diagram_nodes_href(workspace_id: &str) -> String {
    format!("{}/nodes", workspace_diagram_href(workspace_id))
}

pub(super) fn workspace_diagram_node_href(workspace_id: &str, node_id: &str) -> String {
    format!("{}/{node_id}", workspace_diagram_nodes_href(workspace_id))
}

pub(super) fn workspace_diagram_edges_href(workspace_id: &str) -> String {
    format!("{}/edges", workspace_diagram_href(workspace_id))
}

pub(super) fn workspace_diagram_edge_href(workspace_id: &str, edge_id: &str) -> String {
    format!("{}/{edge_id}", workspace_diagram_edges_href(workspace_id))
}

pub(super) fn workspace_diagram_propose_model_href(workspace_id: &str) -> String {
    format!("{}/propose-model", workspace_diagram_href(workspace_id))
}
