...
export interface paths {
  ...
  '/api/workspaces/{workspaceId}/stories/{storyId}/coding-runs': {
    ...
    put?: never;
    post: operations['start_coding_run'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/workspaces/{workspaceId}/coding-runs/{runId}': {
    parameters: {
      query?: never;
      header?: never;
      path: {
  ...
  '/api/workspaces/{workspaceId}/coding-runs/{runId}/review': {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    get?: never;
    put?: never;
    post: operations['submit_coding_run_for_review'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/workspaces/{workspaceId}/coding-runs/{runId}/fail': {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    get?: never;
    put?: never;
    post: operations['fail_coding_run'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/workspaces/{workspaceId}/coding-runs/{runId}/cancel': {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    get?: never;
    put?: never;
    post: operations['cancel_coding_run'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/workspaces/{workspaceId}/coding-runs/{runId}/accept': {
    ...
    get?: never;
    put?: never;
    post: operations['accept_coding_run'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/workspaces/{workspaceId}/coding-runs/{runId}/reject': {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    get?: never;
    put?: never;
    post: operations['reject_coding_run'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface components {
  schemas: {
    ...
    CodingRunStatus:
      ...
      | 'rejected';
    /** @enum {string} */
    CodingRunQualityStatus: 'passed' | 'failed' | 'skipped';
    CodingRunQualityCheck: {
      name: string;
      status: components['schemas']['CodingRunQualityStatus'];
      /** Format: int32 */
      durationMs: number | null;
      summary: string | null;
    };
    CodingRunVersionInput: {
      /** Format: int32 */
      expectedVersion: number;
    };
    StartCodingRunInput: {
    ...
    CodingRunReviewInput: components['schemas']['CodingRunVersionInput'] & {
      diffSha256: string;
      /** Format: int32 */
      changedFileCount: number;
      qualityChecks: components['schemas']['CodingRunQualityCheck'][];
    };
    CodingRunFailureInput: components['schemas']['CodingRunVersionInput'] & {
      code: string;
      summary: string;
    };
    CodingRunAcceptanceInput: components['schemas']['CodingRunVersionInput'] & {
      diffSha256: string;
      commitSha: string;
    };
    CodingRunRejectionInput: components['schemas']['CodingRunVersionInput'] & {
      reason: string;
    };
    CodingRunResource: {
      _links: components['schemas']['BTreeMap'];
    ...
    CodingRunCollectionEmbedded: {
      codingRuns: components['schemas']['CodingRunResource'][];
    };
    CodingRunCollectionResource: {
      _links: components['schemas']['BTreeMap'];
      _embedded: components['schemas']['CodingRunCollectionEmbedded'];
      page: components['schemas']['PageModel'];
    };
    TemplateProperty: {
      /** Format: int32 */
...
export interface operations {
  ...
  list_coding_runs: {
    ...
    requestBody?: never;
    responses: {
      /** @description Coding Runs locked to one Story */
      200: {
        headers: {
          [name: string]: unknown;
        };
        content: {
          'application/vnd.evidence.coding-runs+json': components['schemas']['CodingRunCollectionResource'];
        };
      };
      400: components['responses']['ValidationError'];
      404: components['responses']['ResourceNotFound'];
  ...
  start_coding_run: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['StartCodingRunInput'];
      };
    };
    responses: {
      /** @description Running Coding Run locked to the latest Scenario-bearing Story Revision */
      201: {
        headers: {
          Location?: string;
          [name: string]: unknown;
        ...
        content: {
          'application/vnd.evidence.coding-run+json': components['schemas']['CodingRunResource'];
        };
      };
      400: components['responses']['ValidationError'];
      404: components['responses']['ResourceNotFound'];
  ...
  get_coding_run: {
    ...
    requestBody?: never;
    responses: {
      /** @description Coding Run execution and decision facts */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  submit_coding_run_for_review: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['CodingRunReviewInput'];
      };
    };
    responses: {
      /** @description Approval-ready Coding Run with bounded local execution facts */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  fail_coding_run: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['CodingRunFailureInput'];
      };
    };
    responses: {
      /** @description Failed Coding Run with a bounded failure summary */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  cancel_coding_run: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['CodingRunVersionInput'];
      };
    };
    responses: {
      /** @description Cancelled Coding Run */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  accept_coding_run: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['CodingRunAcceptanceInput'];
      };
    };
    responses: {
      /** @description Human-accepted Coding Run with its local commit SHA */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  reject_coding_run: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['CodingRunRejectionInput'];
      };
    };
    responses: {
      /** @description Human-rejected Coding Run */
      200: {
        headers: {
          [name: string]: unknown;
        };
