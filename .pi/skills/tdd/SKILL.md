...
1. 确认 workflow 已选择唯一的 `US-xxx / SC-xxx` 活动工作项。未选择前不得修改业务代码。
2. 阅读该故事、Given/When/Then 示例、模型展开、架构测试策略、适用测试工序、API 契约和完成定义（DoD）。
...
7. 写入 `artifacts/05-code/<US-xxx>/<SC-xxx>.md`，记录场景、改动路径、Red/Green/Refactor 证据、命令、结果和剩余风险。
