...
export const PHASE_META: Record<Exclude<Phase, 'complete'>, PhaseMeta> = {
  ...
  planning: {
    ...
    inputs: [
      ...
      'docs/architecture/test-strategy.md',
      'engineering/evidence-workflow/test-processes/',
      'engineering/evidence-workflow/definition-of-done.md',
    ],
    outputs: [
