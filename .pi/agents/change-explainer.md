...
thinking: xhigh
tools: read, bash, evidence_orchestrator_status
---
...
广泛读取相关周边代码、确认 Scenario、建模证据、批准计划、执行 manifest 与确定性 summary。可以用只读 Git 命令检查 baseline 到当前工作树的差异；不得运行测试、质量门禁、开发服务器或任何会改变仓库、Git HEAD、index、状态和证据的命令。
